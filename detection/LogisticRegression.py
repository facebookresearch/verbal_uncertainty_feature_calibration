...
if __name__ == '__main__':
    ...
    parser.add_argument("--predict_split", type=str)
    ...
    out_dir = f"{current_dir}/LR_outputs/{dataset}/{model_name}/"
    ...
    for feature in FEATURES:
        ...
        X_val, y_val = load_data(model_name, test_dataset, predict_split, feature, label_name, prompt_type, use_predicted_test=use_predicted_test, filter_refusal=filter_refusal)
        ...
        if use_predicted_test:
            ...
            output_path = out_dir+ f"{predict_split}_"+"_".join(feature)+".json"
